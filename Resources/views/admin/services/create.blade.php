...
@section('content-header')
    <h1>
        {{ trans('iperformers::services.title.create service') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.iperformers.service.index') }}">{{ trans('iperformers::services.title.services') }}</a></li>
        <li class="active">{{ trans('iperformers::services.title.create service') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.iperformers.service.store'], 'method' => 'post']) !!}
    <div class="row">
