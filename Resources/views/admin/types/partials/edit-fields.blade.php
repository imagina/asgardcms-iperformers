<div class="box-body">
    <div class='form-group{{ $errors->has("{$lang}.title") ? ' has-error' : '' }}'>
        ...
        <?php $old = $type->hasTranslation($lang) ? $type->translate($lang)->title : '' ?>
        {!! Form::text("{$lang}[title]", old("{$lang}.title", $old), ['class' => 'form-control', 'data-slug' => 'source', 'placeholder' => trans('iperformers::types.form.title')]) !!}
        {!! $errors->first("{$lang}.title", '<span class="help-block">:message</span>') !!}
    </div>

    <div class='form-group{{ $errors->has("{$lang}[slug]") ? ' has-error' : '' }}'>
        {!! Form::label("{$lang}[slug]", trans('iperformers::types.form.slug')) !!}
        <?php $old = $type->hasTranslation($lang) ? $type->translate($lang)->slug : '' ?>
        {!! Form::text("{$lang}[slug]", old("{$lang}.slug", $old), ['class' => 'form-control slug', 'data-slug' => 'target', 'placeholder' => trans('iperformers::types.form.slug')]) !!}
        {!! $errors->first("{$lang}.slug", '<span class="help-block">:message</span>') !!}
    </div>

    <?php $old = $type->hasTranslation($lang) ? $type->translate($lang)->description : '' ?>
    <div class='form-group{{ $errors->has("$lang.description") ? ' has-error' : '' }}'>
    @editor('description', trans('iperformers::types.form.description'), old("$lang.description", $old), $lang)
    </div>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body ">
                <div class='form-group{{ $errors->has("{$lang}.metatitle") ? ' has-error' : '' }}'>
                    {!! Form::label("{$lang}[metatitle]", trans('iperformers::types.form.metatitle')) !!}
                    <?php $old = $type->hasTranslation($lang) ? $type->translate($lang)->metatitle : '' ?>
                ...
                <div class='form-group{{ $errors->has("{$lang}.metakeywords") ? ' has-error' : '' }}'>
                    {!! Form::label("{$lang}[metakeywords]", trans('iperformers::types.form.metakeywords')) !!}
                    <?php $old = $type->hasTranslation($lang) ? $type->translate($lang)->metatitle : '' ?>
                ...
                <?php $old = $type->hasTranslation($lang) ? $type->translate($lang)->metadescription : '' ?>
                @editor('content', trans('iperformers::performers.form.metadescription'), old("$lang.metadescription", $old), $lang)
            </div>
        </div>
    </div>
