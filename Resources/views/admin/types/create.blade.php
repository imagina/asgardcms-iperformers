...
@section('content-header')
    <h1>
        {{ trans('iperformers::types.title.create type') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i
                        class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li>
            <a href="{{ route('admin.iperformers.type.index') }}">{{ trans('iperformers::types.title.types') }}</a>
        </li>
        <li class="active">{{ trans('iperformers::types.title.create type') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.iperformers.type.store'], 'method' => 'post']) !!}
    <div class="row">
                            ...
                            <div class="tab-content">
                                ...
                                @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                                    ...
                                    <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                                        @include('iperformers::admin.types.partials.create-fields', ['lang' => $locale])
                                    </div>
                                @endforeach
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body ">
                            <div class="box-footer">
                                ...
                                <a class="btn btn-danger pull-right btn-flat" href="{{ route('admin.iperformers.type.index')}}">
