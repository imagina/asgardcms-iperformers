...
use Modules\Iperformers\Transformers\ServiceTransformers;
    ...
    public function update(Service $service, Request $request)
    {
        ...
        try {
            ...
            if (isset($service->id) && !empty($service->id)) {
                ...
                isset($request->mainimage) ? $options["mainimage"] = saveImage($request['mainimage'], "assets/iperformers/service/" . $service->id . ".jpg") : false;
                ...
                $response = [
                    'susses' => [
                        ...
                        "title" => trans('core::core.messages.resource updated', ['name' => trans('iperformers::services.singular')]),
                        "detail" => [
                            'id' => $service->id
                        ]
                    ]
    ...
    public function delete(Service $service, Request $request)
    {
        try {
            ...
            $response = [
                'susses' => [
                    'code' => '201',
                    "title" => trans('core::core.messages.resource deleted', ['name' => trans('iperformers::services.singular')]),
                    "detail" => [
                        'id' => $service->id
                    ]
                ]
